...
#load urma
    ...
    def create_config(self):
        ...
        self.config.environment.render = True
    ...
    def main(self, argv):
        ...
        self.compare_models(self.residual_policy)

    def compare_models(self, residual_policy):

        residual_results = self.run_test_episode()

        for axis in ["x", "y", "yaw"]:
            self.plot_tracking_comparison(residual_results, axis)
    ...
    def plot_tracking_comparison(
        ...
        plt.savefig(
            f"/workspace/single_{axis}_displacement_comparison.png",
            dpi=300,
        )
    ...
    def set_goal_velocity(self):
        self.robot_env.goal_x_velocity = 0.3
        self.robot_env.goal_y_velocity = 0.0
        self.robot_env.goal_yaw_velocity = 0.0

        self.robot_env.res_goal_x_velocity = 0.0
        self.robot_env.res_goal_y_velocity = 0.0
        self.robot_env.res_goal_yaw_velocity = 0.0
